				...
				<div class="page-content">
					...
					<div class="page-content-area">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" name='blogAdd' id='blogAdd' action="<?php echo U(GROUP_NAME.'/System/friendEdit');?>" method='post'>
								<input type="hidden" name='id' value='<?php echo ($friend["id"]); ?>'/>
									<!-- #section:elements.form -->
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2">友链名称：</label>
											
										<div class="col-sm-9">
										<input type="text" name='title' id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" value='<?php echo ($friend["title"]); ?>'/></div>
											
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 友链地址：</label>

										<div class="col-sm-9">
											<input type="text" name='url' id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" value='<?php echo ($friend["url"]); ?>'/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">友链详情： </label>
										<div class="col-sm-9">
											<textarea name='beian' id='' style="margin: 0px; width: 580px; height: 89px;"/><?php echo ($friend["beian"]); ?></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">友链排序： </label>

										<div class="col-sm-9">
											<input type="text" name='sort' id="form-field-1-1" placeholder="" value='<?php echo ($friend["sort"]); ?>' class=" col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-2">
											<div class="pos-rel">
												<select class="form-control" name='display' id="form-field-select-1">
																<option <?php if($friend["display"] == "1"): ?>selected<?php endif; ?> value="0" >显示</option>
																<option <?php if($friend["display"] == "2"): ?>selected<?php endif; ?> value="1">不显示</option>
												</select>
											</div>
										</div>
									</div>
