...
<html lang="en">
	...
	<body class="login-layout blur-login">
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							...
							<div class="position-relative">
								<div id="login-box" class="login-box <?php if($_GET['rg']== ""): ?>visible<?php endif; ?> widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form name="login" id="login" action='<?php echo U(GROUP_NAME.'/Login/checkLogin');?>' method='post'>
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" name="username" placeholder="用户名" value='<?php echo ($_GET['username']); ?>'/>
													...
													<div class="clearfix">
														...
														<button type="button" id='login-operation' class="width-35 pull-right btn btn-sm btn-primary">
								...
								<div id="signup-box" class="signup-box widget-box no-border <?php if($_GET['rg']!= ""): ?>visible<?php endif; ?>">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form name="register" id="register" action='<?php echo U(GROUP_NAME.'/Login/register');?>' method='post'>
												<fieldset>
													<!-- <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="email" class="form-control" placeholder="Email" />
													...
													<label class="block">
														<input type="checkbox" name='xieyi' class="ace" />
														<span class="lbl">
															我接受
															<a href="#">用户协议</a>
														</span>
		...
		<script type="text/javascript">
			...
			$('#login-operation').click(function(){
