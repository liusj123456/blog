				...
				<div class="page-content">
					...
					<div class="page-content-area">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" name='blogAdd' id='blogAdd' action="<?php echo U(GROUP_NAME.'/System/friendAdd');?>" method='post'>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name='beian' id='' style="margin: 0px; width: 580px; height: 89px;"/></textarea>
										</div>
									</div>
									<div class="form-group">
