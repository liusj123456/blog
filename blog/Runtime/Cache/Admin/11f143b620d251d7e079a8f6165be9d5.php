				...
				<div class="page-content">
					...
					<div class="page-content-area">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" name='blogAdd' id='blogAdd' action="<?php echo U(GROUP_NAME.'/User/userAdd');?>" method='post'>
									<!-- #section:elements.form -->
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 用户名：</label>

										<div class="col-sm-9">
											<input type="text" name='username' id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
