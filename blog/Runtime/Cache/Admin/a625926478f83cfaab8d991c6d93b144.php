				...
				<div class="page-content">
					...
					<div class="page-content-area">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" name='menuAdd' id='menuAdd' action="<?php echo U(GROUP_NAME.'/Blog/blogTypeEdit');?>" method='post'>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name='name' id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" value='<?php echo ($t["name"]); ?>'/>
										</div>
									</div>
									<!-- /section:elements.form -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name='url' id="form-field-2" placeholder="" class="col-xs-10 col-sm-5" value='<?php echo ($t["url"]); ?>'/>
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name='sort' id="form-field-2" placeholder="" class="col-xs-10 col-sm-5" value='<?php echo ($t["sort"]); ?>'/>
										</div>
									</div>
										...
										<div class="col-sm-2">
											<div class="pos-rel">
												<select class="form-control" name='display' id="form-field-select-1">
																<option <?php if($v["display"] == "0"): ?>selected<?php endif; ?> value="0" >显示</option>
																<option <?php if($v["display"] == "1"): ?>selected<?php endif; ?> value="1">不显示</option>
												</select>
											</div>
										</div>
									</div>
