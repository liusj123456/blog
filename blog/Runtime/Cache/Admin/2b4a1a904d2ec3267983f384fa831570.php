				...
				<div class="col-xs-12">
					...
					<div class="table-responsive">
						...
						<table id="sample-table-2" class="table table-striped table-bordered table-hover">
							...
							<tbody>
							<?php if(is_array($friend)): $i = 0; $__LIST__ = $friend;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$friend): $mod = ($i % 2 );++$i;?><tr>
									<td class="center">
										<label class="position-relative">
											<input type="checkbox" class="ace" />
											<span class="lbl"></span>
									...
									<td><?php echo ($friend["title"]); ?></td>
									<td><?php echo ($friend["url"]); ?></td>
									<td><?php echo ($friend["beian"]); ?></td>
									<td><?php if($friend["display"] == 0): ?>显示<?php else: ?>不显示<?php endif; ?></td>
									<td><?php echo ($friend["sort"]); ?></td>
									<td><?php echo ($friend["addUser"]); ?></td>
									<td><?php echo (date('Y-m-d H:i:s',$friend["addTime"])); ?></td>
									<td>
...
-->
											<button class="btn btn-xs btn-info" title="修改" onclick='javascript:location.href="<?php echo U(GROUP_NAME.'/System/friendEdit',array('id'=>$friend['id']));?>";'>
												<i class="ace-icon fa fa-pencil bigger-120"></i>
											</button>

											<button class="btn btn-xs btn-danger" title="删除" onclick='javascript:if(confirm("确定删除吗？")) location.href="<?php echo U(GROUP_NAME.'/System/friendDel',array('id'=>$friend['id']));?>";'>
						...
						<div class="modal-footer no-margin-top">
							<button class="btn btn-grey" style="float:left;" onclick='javascript:location.href="<?php echo U(GROUP_NAME.'/System/friendAdd');?>";'>添加友情链接</button>
