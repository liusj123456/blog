...
-->
											<button class="btn btn-xs btn-info" title="修改" onclick='javascript:location.href="<?php echo U(GROUP_NAME.'/Blog/blogTypeEdit',array('id'=>$vo['id']));?>";'>
												<i class="ace-icon fa fa-pencil bigger-120"></i>
											</button>

											<button class="btn btn-xs btn-danger" title="删除" onclick='javascript:if(confirm("确定删除吗？")) location.href="<?php echo U(GROUP_NAME.'/Blog/blogTypeDel',array('id'=>$vo['id']));?>";'>
												<i class="ace-icon fa fa-trash-o bigger-120"></i>
											</button>

											<button class="btn btn-xs btn-success" title="添加子类型" onclick='javascript:location.href="<?php echo U(GROUP_NAME.'/Blog/blogTypeAdd',array('id'=>$vo['id']));?>";'>
						...
						<div class="modal-footer no-margin-top">
							<button class="btn btn-grey" style="float:left;" onclick='javascript:location.href="<?php echo U(GROUP_NAME.'/Blog/blogTypeAdd');?>";'>添加顶级类型</button>
