	   	...
	   	$.each(obj,function(n,idx) {
			...
			$("#"+idx).uploadify({
	            ...
	            'onUploadSuccess':function(file,data,response){
					...
					imgstr = '<a href="'+pic_url+'" target="_blank"><img src="'+pic_url+'" width="25" height="29" /></a>';
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" name='blogAdd' id='blogAdd' action="<?php echo U(GROUP_NAME.'/Blog/blogAdd');?>" method='post'>
									...
									<div class="form-group">
										...
										<span id="files_legal">
										  <input id="legal" name="legal" type="file">
									   </span>&nbsp;&nbsp;
									   
									   <div id="files_preview_legal" style="width:auto;height:auto; overflow :auto"></div>
									   <input id="file_legal" value="" type="hidden">
										</div>
									</div>
									<div class="form-group">
