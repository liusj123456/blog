				...
				<div class="page-content">
					...
					<div class="page-content-area">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" name='blogAdd' id='blogAdd' action="<?php echo U(GROUP_NAME.'/User/userEdit');?>" method='post'><input type="hidden" name='id' id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" value='<?php echo ($user["id"]); ?>'/>
									<!-- #section:elements.form -->
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 用户名：</label>

										<div class="col-sm-9">
											<input type="text" name='username' id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" value='<?php echo ($user["username"]); ?>'/>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" name='password' id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" /><font style='color:red;'>不修改请放空</font>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" name='repassword' id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-2">
											<div class="pos-rel">
												<select class="form-control" name='status' id="form-field-select-1">
																<option <?php if($user["status"] == "0"): ?>selected<?php endif; ?> value="0" >可用</option>
																<option <?php if($user["status"] == "1"): ?>selected<?php endif; ?> value="1">不可用</option>
												</select>
											</div>
										</div>
									</div>
