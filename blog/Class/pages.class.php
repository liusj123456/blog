...
class page {
    ...
    public $myde_size;           //一页显示的记录数
    public $myde_page;           //当前页
    public $myde_page_count;     //总页数
    public $myde_i;              //起头页数
    public $myde_en;             //结尾页数
    public $myde_url;            //获取当前的url
	public $limit;           //当前起始行数
	public $varPage;          
    /*
     * $show_pages
    ...
    public function __construct($myde_total = 1, $myde_size = 1, $myde_page = 1, $myde_url="?page={page}", $show_pages = 1) {
